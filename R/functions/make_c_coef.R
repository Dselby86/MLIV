#' make_c_coef::  make c_coef set to use for regression plots (taken from sree_2024_plots.R)
#' 
...
#' 
#' @return outputs c_coef
#'
#' @export
#' 
#' 
make_c_coef = function(df, scen_dataset, scen_outcome){
