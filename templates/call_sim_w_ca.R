...
###################################################################################
# STEP 6: RUN THE SIMULATION WITH CA
###################################################################################
...
ca_simulation <- run_simulation(
                                ...
                                outcome = "BMEFTMEDIAN", #Y18JBERNA_06", #BMEFTMEDIAN
...
#   ca_small_set = ca_small_set,
#   ca_medium_set = ca_medium_set,
#   ca_large_set = ca_large_set
# )
# 
# ca_outcomes <- c(
#   "Y18JBERNA_06",     # YRS 1-8: AVG MONTHLY EARNINGS IN 2006 DOLLARS (LQ & EQ DATA)
