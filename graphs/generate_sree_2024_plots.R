...
source( here::here( "graphs/functions/contour_plot_code.R" ) )



# Check if the "sree2024" directory exists, if not, create it
if (!dir.exists(here::here("graphs/plots/sree2024"))) {
  cat( "Creating directory for SREE 2024 plots\n" )
  dir.create(here::here("graphs/plots/sree2024"))
}
...
ggsave( filename = "graphs/plots/sree2024/contour_RFT_1000_legend.pdf", width = 7, height = 5 )
...
ggsave("graphs/plots/sree2024/legend_only.png", plot = legend_plot, width = 5, height = 5)
...
ggsave( filename = "graphs/plots/sree2024/contour_RFT_1000.pdf", width = IMAGE_WIDTH, height = 5 )
...
ggsave( filename = "graphs/plots/sree2024/contour_all_1000.pdf", width = IMAGE_WIDTH, height = 5 )
...
ggsave( filename = "graphs/plots/sree2024/contour_trail_to_large.pdf", 
...
ggsave( filename = "graphs/plots/sree2024/contour_trail_to_2000.pdf", width = IMAGE_WIDTH, height = 5 )
...
if ( FALSE ) {
  ...
  ggsave( filename = "graphs/plots/sree2024/binary_ca.pdf", width = IMAGE_WIDTH, height = 5 )
...
ggsave( filename = "graphs/plots/sree2024/all_queen_plot.pdf", width = 11, height = 6 )
...
ggsave( filename = "graphs/plots/sree2024/coef_plot.pdf", width = 11, height = 6 )
...
ggsave( filename = "graphs/plots/sree2024/coef_plot.pdf",
        width = 7, height = 6 ) 
...
ggsave( filename = "graphs/plots/sree2024/coef_plot_queen.pdf",
        width = 7, height = 6 ) 
...
ggsave( filename = "graphs/plots/sree2024/ex_factor_plot.pdf", 
        width = 7, height = 6 ) 
